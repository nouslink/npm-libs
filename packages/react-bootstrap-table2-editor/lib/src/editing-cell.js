...
export default ((_, onStartEdit) => class EditingCell extends Component {
  ...
  beforeComplete(newValue) {
    ...
    if (_.isFunction(column.validator)) {
      const validateForm = column.validator(newValue, row, column, this.asyncbeforeCompete(newValue));
  ...
  render() {
    ...
    if (_.isFunction(column.editorRenderer)) {
      ...
      editor = /*#__PURE__*/React.createElement(DropdownEditor, _extends({}, editorProps, {
        row: row,
        column: column
      }));
    } else if (isDefaultEditorDefined && column.editor.type === EDITTYPE.TEXTAREA) {
      editor = /*#__PURE__*/React.createElement(TextAreaEditor, _extends({}, editorProps, {
        autoSelectText: autoSelectText
      }));
    } else if (isDefaultEditorDefined && column.editor.type === EDITTYPE.CHECKBOX) {
      editor = /*#__PURE__*/React.createElement(CheckBoxEditor, editorProps);
    } else if (isDefaultEditorDefined && column.editor.type === EDITTYPE.DATE) {
      editor = /*#__PURE__*/React.createElement(DateEditor, editorProps);
    } else {
      editor = /*#__PURE__*/React.createElement(TextEditor, _extends({}, editorProps, {
        autoSelectText: autoSelectText
      }));
    }
    ...
    }, editor, hasError ? /*#__PURE__*/React.createElement(EditorIndicator, {
