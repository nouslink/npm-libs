...
const CellEditContext = /*#__PURE__*/React.createContext();
export default ((_, dataOperator, isRemoteCellEdit, handleCellChange) => {
  class CellEditProvider extends React.Component {
    ...
    handleCellUpdate(row, column, newValue) {
      ...
      if (_.isFunction(beforeSaveCell)) {
        const result = beforeSaveCell(oldValue, newValueWithType, row, column, beforeSaveCellDone);
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement(CellEditContext.Provider, {
        value: {
          ...newCellEdit
        }
      }, this.props.children);
