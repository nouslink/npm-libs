...
export const filterByText = _ => (data, dataField, {
  filterVal: userInput = '',
  comparator = LIKE,
  caseSensitive
}, customFilterValue) => {
...
export const filterByNumber = _ => (data, dataField, {
  filterVal: {
    comparator,
    number
  }
}, customFilterValue) => data.filter(row => {
...
export const filterByDate = _ => (data, dataField, {
  filterVal: {
    comparator,
    date
  }
...
export const filterByArray = _ => (data, dataField, {
  filterVal,
  comparator
}) => {
