...
class DateFilter extends Component {
  ...
  componentDidMount() {
    ...
    if (getFilter) {
      getFilter(filterVal => {
        const nullableFilterVal = filterVal || {
          date: null,
          comparator: null
        };
  ...
  applyFilter(value, comparator, isInitial) {
    ...
    const execute = () => {
      ...
      onFilter(column, FILTER_TYPE.DATE, isInitial)({
        date,
        comparator
      });
    };
  ...
  render() {
    ...
    }, this.getComparatorOptions())), /*#__PURE__*/React.createElement("label", {
      htmlFor: inputElmId
    }, /*#__PURE__*/React.createElement("span", {
      className: "sr-only"
    }, "Enter $", text), /*#__PURE__*/React.createElement("input", {
