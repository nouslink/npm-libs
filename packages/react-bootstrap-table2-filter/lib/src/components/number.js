...
const legalComparators = [Comparator.EQ, Comparator.NE, Comparator.GT, Comparator.GE, Comparator.LT, Comparator.LE];
class NumberFilter extends Component {
  ...
  componentDidMount() {
    ...
    if (comparator && number) {
      onFilter(column, FILTER_TYPE.NUMBER, true)({
        number,
        comparator
      });
    }
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "sr-only"
    }, "Filter comparator"), /*#__PURE__*/React.createElement("select", {
    ...
    }, this.getComparatorOptions())), options ? /*#__PURE__*/React.createElement("label", {
      className: "filter-label",
      htmlFor: inputElmId
    }, /*#__PURE__*/React.createElement("span", {
      className: "sr-only"
    }, `Select ${column.text}`), /*#__PURE__*/React.createElement("select", {
    ...
    }, this.getNumberOptions())) : /*#__PURE__*/React.createElement("label", {
      htmlFor: inputElmId
    }, /*#__PURE__*/React.createElement("span", {
      className: "sr-only"
    }, `Enter ${column.text}`), /*#__PURE__*/React.createElement("input", {
      ref: n => this.numberFilter = n,
      id: inputElmId,
      type: "number",
      style: numberStyle,
