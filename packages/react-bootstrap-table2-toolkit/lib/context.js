...
const ToolkitContext = /*#__PURE__*/React.createContext();
class ToolkitProvider extends statelessDecorator(React.Component) {
  static propTypes = {
    ...
    exportCSV: PropTypes.oneOfType([PropTypes.bool, PropTypes.shape({
  ...
  constructor(props) {
    ...
    if (props.columnToggle) {
      state.columnToggle = props.columns.reduce((obj, column) => {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.columnToggle) {
      columnToggle = nextProps.columns.reduce((obj, column) => {
        obj[column.dataField] = !column.hidden;
        return obj;
      }, {});
    } else {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(ToolkitContext.Provider, {
      value: {
        searchProps: {
          searchText: this.state.searchText,
