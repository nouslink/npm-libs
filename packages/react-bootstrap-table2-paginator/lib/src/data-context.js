...
const PaginationDataContext = /*#__PURE__*/React.createContext();
class PaginationDataProvider extends Provider {
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    ...
    const pageStartIndex = typeof nextProps.pagination.options.pageStartIndex !== 'undefined' ? nextProps.pagination.options.pageStartIndex : Const.PAGE_START_INDEX;

    // user should align the page when the page is not fit to the data size when remote enable
    if (!this.isRemotePagination() && !custom) {
      const newPage = alignPage(nextProps.data.length, this.props.data.length, this.currPage, currSizePerPage, pageStartIndex);
  ...
  render() {
    ...
    data = this.isRemotePagination() ? data : getByCurrPage(data, currPage, currSizePerPage, pageStartIndex);
    return /*#__PURE__*/React.createElement(PaginationDataContext.Provider, {
      value: {
        data,
